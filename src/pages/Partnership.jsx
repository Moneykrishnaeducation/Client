    ...
    <div className="space-y-3">
      {clients.map((client) => {
        ...
        return (
          <div
            key={client.id}
            className="border-b border-yellow-200 rounded-md p-3 bg-black shadow-sm hover:shadow-lg transition-shadow duration-300"
          >
            {/* Client Header */}
            <div
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-gray-100 p-6">
        ...
        <>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 w-full">
            ...
            <div className="flex flex-wrap gap-3 justify-end w-full sm:w-auto">
              ...
              <button
                className="flex items-center gap-2 bg-yellow-500 text-black px-3 py-2 rounded-md font-semibold hover:bg-yellow-400 shadow-md hover:shadow-lg transition-all flex-shrink-0"
          ...
          {/* Client Tree */}
          <div className="bg-black-900 p-4 rounded-md border-yellow-500 shadow-md hover:shadow-[0_4px_15px_rgba(255,215,0,0.4)] transition-shadow duration-300">
      ...
      {/* Add User Form Modal with Backdrop Blur */}
      {showAddUserForm && (
...
{activeTab === 'Commission' && (
  <div className="bg-black rounded-xl shadow-2xl  border-yellow-10 p-6 space-y-4 transition-shadow">
        ...
        <thead>
          <tr className="bg-black text-yellow-300">
            {['#', 'Date', 'User', 'Type', 'Amount', 'Status'].map((header, i) => (
              <th key={i} className="px-4 py-2 text-left whitespace-nowrap">{header}</th>
            ))}
          </tr>
        </thead>
        <tbody>
